...
const files = [
    ...
    { source: 'Minecraft.Client/XboxMedia/584111F70AAAAAAA', target: '584111F70AAAAAAA', optional: true, errors: { ENOENT: { fix: (file) => fs.mkdirSync(file.source) } } },
...
const targetDir = path.join(__dirname, 'MinecraftConsoles_Xbox360');
